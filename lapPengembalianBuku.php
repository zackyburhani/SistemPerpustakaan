...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <small><b>Halaman Laporan Pengembalian Buku</b></small>
    </h1>
  </section>
    ...
    <div class="col-lg-12">
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-file-text fa-fw"></i> Laporan Pengembalian Buku</h3>
        </div>

        <div class="box-body">
          <div class="form-group">
            <form action="laporan/proses_lapPengembalianBuku.php" method="POST">
